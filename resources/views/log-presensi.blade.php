...
<div class="max-w-4xl mx-auto mt-10">
    <div class="bg-gray-700 p-6 rounded-lg shadow-md">
        ...
        {{-- Tombol Kembali --}}
        <div class="mb-4">
            <a href="{{ route('presensi.form') }}" class="inline-block bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md transition">
                ←
            </a>
        </div>
        ...
        @if($presensis->count())
            <table class="w-full table-auto text-left border">
                <thead>
                    <tr class="bg-gray-700 p-6 rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="p-2 border">{{ $presensi->geolokasi ?? '-' }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
